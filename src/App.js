    ...
    <div className="App">
            ...
            <ul className="navbar-nav ms-auto">
              {!linksEnabled && (
                <li className="nav-item">
                  <a className="nav-link text-danger" href="#captcha">
                    Habilite os links!
                  </a>
                </li>
              )}
              <li className="nav-item">
                <a className="nav-link" href="#repair">
                  Assistências
                </a>
              </li>
              <li className="nav-item">
          ...
          <div className="row gx-4 gx-lg-5 justify-content-center">
            <div className="col-lg-8">
              ...
              <p className="text-white-50 mb-3">
                A Comunidade Fuji Brasil é um grupo de fotógrafos, profissionais
                e entusiastas, que utilizam câmeras e demais equipamentos
                fotográficos Fujifilm.
              </p>
              <p className="text-white-50 mb-3">
                Na nossa comunidade, nós nos apoiamos e fortalecemos a presença
                da marca no Brasil.
              </p>
              <p className="text-white-50 mb-5">
                Nosso advogado mandou dizer: não temos qualquer filiação com a
                Fujifilm ou uma de suas subsidiárias. Não representamos a marca
                ou seus produtos.
              </p>
              <a
                className={`btn btn-primary mb-5 ${
                  linksEnabled ? "" : "disabled"
                }`}
                href={
                  linksEnabled
                    ? "https://chat.whatsapp.com/FL1U8gZjHJS7ZnkFoKHypj"
                    : ""
                }
              >
                Faça parte!
      ...
      <section className="pt-5 pb-5 bg-light" id="repair">
        <div className="container px-4 px-lg-5">
          ...
          <div className="row gx-4 gx-lg-5">
            {isFetching && (
              <p>
                Carregando <FontAwesomeIcon icon={faCog} className="fa-spin" />
              </p>
            )}
            {!isFetching &&
              data.repairShops.map((s, ix) => (
                <RepairShop shop={s} key={ix} linksEnabled={linksEnabled} />
              ))}
          </div>
        </div>
      </section>
      <section className="signup-section" id="stores">
        <div className="container px-4 px-lg-5">
          ...
          <div className="row gx-4 gx-lg-5">
            ...
            {!isFetching &&
              data.stores.map((s, ix) => (
                <Store store={s} key={ix} linksEnabled={linksEnabled} />
              ))}
          </div>
        </div>
      </section>
      <section className="bg-black text-center text-white-50" id="partners">
        <div className="container px-4 px-lg-5">
          <div className="row gx-4 gx-lg-5">
            <div className="col-md-10 col-lg-8 mx-auto text-center">
              <FontAwesomeIcon
                ...
                className="fa-2x mb-2 text-white"
              />
              <h2 className="text-white mb-5">Parcerias</h2>
            </div>
          </div>
          <div className="row gx-4 gx-lg-5">
            {isFetching && (
            ...
            {!isFetching &&
              data.partners.map((s, ix) => (
                <Partnership partner={s} key={ix} linksEnabled={linksEnabled} />
              ))}
          </div>
        </div>
      </section>
      <section className="pt-5 pb-5 bg-light projects-section">
        ...
        <div className="container px-4 px-lg-5">
          ...
          {!isFetching &&
            data?.links.map((s, ix) => <Link link={s} key={ix} index={ix} />)}
        </div>
      </section>
      <footer className="footer bg-black small text-center text-white-50">
        <div className="container px-4 px-lg-5">
          <p className="p-3 mx-auto text-center">
            <small>
              A Comunidade Fuji Brasil não se responsabiliza por quaisquer
              negócios realizados com as lojas e assistências técnicas acima.
            </small>
          </p>
        </div>
      </footer>
